...
namespace Abenmada\MultiFactorAuthenticationPlugin\Controller\Action\ShopUser;

use Abenmada\MultiFactorAuthenticationPlugin\Controller\Action\ToggleEnableAction as BaseToggleEnableAction;
use Abenmada\MultiFactorAuthenticationPlugin\Form\Type\ShopUser\ToggleEnableType as ShopUserToggleEnableAction;
...
class ToggleEnableAction extends BaseToggleEnableAction
{
    ...
    {
        return $this->toggle($request, ShopUserToggleEnableAction::class, '@MultiFactorAuthenticationPlugin/Form/ShopUser/index.html.twig');
    }
}
